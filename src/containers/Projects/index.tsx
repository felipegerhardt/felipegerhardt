            ...
            <div className='image__container'>
              <div className="KOSR_container">
                ...
                <div className="KOSR_gifs_container">
                  <img alt='KOST print screen' data-aos="fade-left" src={project.images[1]} width={150} height={(331/600)*(150)} className='KOSR_gifs1'/>
                  <img alt='KOST print screen' data-aos="fade-left" src={project.images[2]} width={150} height={(331/600)*(150)} className='KOSR_gifs2'/>
                </div>
              </div>
            </div>}
          </div>
